// Edge Case 1 object destructuring
...
// Edge Case 2 object destructuring and renaming
const user = {
  id: 101,
  personalInfo: {
    name: 'Alice',
...
/*----destructuring to swap array elements----*/

const fruits = ['banana','pineapple','strawberry','Apple'];
